...
public class RequeteKahoot {
    ...
    private String url = "jdbc:mysql://127.0.0.1/poo2020?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
...
//            Class.forName("com.mysql.jdbc.Driver");
    ...
    public List<Categorie> getListeCategories() {
        ResultSet result = executeQuery("SELECT * FROM `categorie`;");
    ...
    public int getNbJoueurs() {
        ResultSet result = executeQuery("SELECT count(idCATEGORIE) AS count FROM `categorie`;");
        int res = -1;
        try {
            result.next();
    ...
    public int addCategorie(Categorie c) {
        ...
        ResultSet result = updateQuery("INSERT INTO `categorie`(texteCATEGORIE) VALUES(?);", args, Statement.RETURN_GENERATED_KEYS);
        int id = -1;
        try {
            if(result != null) {
                result.next();
    ...
    public Categorie getCategorieById(int id) {
        ...
        args.add(id);
        ResultSet result = executeQuery("SELECT * FROM `categorie` WHERE `idCATEGORIE`=?;", args);
    ...
    public Categorie getCategorieByText(String cat) {
        ...
        args.add(cat);
        ResultSet result = executeQuery("SELECT * FROM `categorie` WHERE `texteCATEGORIE`=?;", args);
    ...
    public int addQuestion(Question q) {
        ...
        ResultSet result = updateQuery("INSERT INTO `question`(ID_BONNE_REPONSE, ID_CATEGORIE, texteQUESTION) VALUES(?,?,?);", args, Statement.RETURN_GENERATED_KEYS);
        int id = -1;
        try {
            if(result != null) {
                result.next();
    ...
    public Question getQuestionById(int id) {
        List<Integer> args = new ArrayList<>();
        args.add(id);
        ResultSet result = executeQuery("SELECT * FROM `question` WHERE `ID_QUESTION`=?;", args);
    ...
    public Question getQuestionByText(String rep) {
        List<String> args = new ArrayList<>();
        args.add(rep);
        ResultSet result = executeQuery("SELECT * FROM `question` WHERE `texteQUESTION`=?;", args);
    ...
    public int addReponse(Reponse r) {
        ...
        ResultSet result = updateQuery("INSERT INTO `reponse`(texteREPONSE) VALUES(?);", args, Statement.RETURN_GENERATED_KEYS);
        int id = -1;
        try {
            if(result != null) {
                result.next();
    ...
    public Reponse getReponseById(int id) {
        List<Integer> args = new ArrayList<>();
        args.add(id);
        ResultSet result = executeQuery("SELECT * FROM `reponse` WHERE `ID_REPONSE`=?;", args);
    ...
    public Reponse getReponseByText(String rep) {
        List<String> args = new ArrayList<>();
        args.add(rep);
        ResultSet result = executeQuery("SELECT * FROM `reponse` WHERE `texteREPONSE`=?;", args);
    ...
    public int addPropositions(int idQuestion, int idReponse, boolean isBonneReponse) {
        ...
        ResultSet result = updateQuery("INSERT INTO `propositions`(ID_QUESTION, ID_REPONSE, bonneReponse) VALUES(?,?,?);", args, Statement.RETURN_GENERATED_KEYS);
        int id = -1;
        try {
            if(result != null) {
                result.next();
    ...
    public List<Reponse> getPropositionsByQuestionId(int id) {
        List<Integer> args = new ArrayList<>();
        args.add(id);
        ResultSet result = executeQuery("SELECT * FROM `propositions` WHERE `ID_QUESTION`=?;", args);
    ...
    public List<Question> getAllQuestions() {
        ResultSet result = executeQuery("SELECT * FROM `question`;");
    ...
    public List<Question> getAllQuestions(int cat) {
        ...
        ResultSet result = executeQuery("SELECT * FROM `question` WHERE `ID_CATEGORIE`=?;", args);
